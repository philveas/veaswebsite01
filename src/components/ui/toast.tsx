  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all",
  {
    variants: {
      ...
      state: {
        ...
        swipe:
          "data-[swipe=move]:translate-x-[var(--radix-toast-swipe-move-x)] data-[swipe=move]:transition-none data-[swipe=end]:translate-x-[var(--radix-toast-swipe-end-x)] data-[swipe=cancel]:translate-x-0",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, variant, state, ...props }, ref) => {
  // a11y: destructive toasts are more urgent
